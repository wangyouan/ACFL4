...
\begin{frame}{APV Example: Step 1 – Unlevered NPV}
	...
	\begin{itemize}
		...
		\item → Without financing help, project should be \textcolor{red}{rejected}.
	\end{itemize}
...
\begin{frame}{APV Example: Step 2 – Add Subsidized Financing Effect}
	...
	\begin{itemize}
		...
		\item → \textbf{Accept} the project: government support turned a negative NPV project into a positive one.
	\end{itemize}
...
\begin{frame}{Step 1: Estimate Levered Cash Flows (LCF)}
	...
	\begin{itemize}
		...
		\item Debt: ¥1,219,000 at 10\% → Interest = ¥121,900
...
\begin{frame}{Step 2: Compute Levered Cost of Equity \( R_S \)}
	...
	\begin{itemize}
		...
		\item Total project value = ¥4,876,000 → Equity = ¥3,657,000
...
\begin{frame}{Step 3: Valuation Using FTE}
	...
	\begin{itemize}
		...
		\item → Project should be \textbf{accepted} from the equityholders’ point of view.
	\end{itemize}
...
\begin{frame}{Step 4: Adjusted Present Value (with Debt)}
	...
	\textbf{Conclusion:}  
	→ Project should be \textbf{accepted} if debt financing is available.
...
\begin{frame}{Final APV with Subsidized Loan}
	...
	\textbf{Conclusion:}  
	→ Subsidized financing significantly enhances project value.  
	→ Governments can make socially beneficial projects financially viable.
